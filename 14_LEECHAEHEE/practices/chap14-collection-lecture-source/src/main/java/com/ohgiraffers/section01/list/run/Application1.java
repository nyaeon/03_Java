...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        alist.add("apple"); //alist[0] = "apple"; 과 비슷
        ...
        * */
        ...
        alist.add("apple");
        alist.add(2, "banana"); // 넣고자 하는 index에 넣을 수 있음
        System.out.println("alist = " + alist);
        // alist = [apple, 123, 45.67, Tue Apr 08 16:14:53 KST 2025, apple

        alist.remove(2);
        System.out.println("alist = " + alist);

        alist.set(4, Boolean.valueOf(true));
        System.out.println("alist = " + alist); // setter와 같음

        List<String> stringList = new ArrayList<>();
        stringList.add("apple");
//        stringList.add(123); // Generic 지정으로 인해 문자열만 들어갈 수 있음
        stringList.add("banana");
        stringList.add("orange");
        stringList.add("mango");
        stringList.add("grape");
        System.out.println("stringList = " + stringList);
        Collections.sort(stringList); // String에는 문자열 오름차순에 대한 정의가 되어 있다.
        System.out.println("stringList = " + stringList);
         ...
         * next() : 다음 요소를 반환
         * */
       Iterator<String> dIter = ((LinkedList<String>) stringList).descendingIterator(); // 연결리스트로 변경 후 내림차순
//        while(dIter.hasNext()) {
