...
public class Application2 {
    public static void main(String[] args) {
        /*
        * range(시작값, 종료값) : 시작값에서 1씩 증가하는 숫자로 종료값 전까지의 범위의 스트림 생성
        * rangeClosed(시작값, 종료값) : 시작값부터 1씩 증가하는 숫자로 종료깞까지 범위의 스트림 생성
        * */
        ...
        * */
        ...
        helloWorldChars.forEach(val -> System.out.print((char) val + " "));

        System.out.println();
        Stream<String> splitStream = Pattern.compile(",").splitAsStream("html, css, javascript");
        splitStream.forEach(System.out::println);

        Stream<String> stringStream = Stream.of("html", "javascript", "world");
//        stringStream.forEach(System.out::println);
        Stream<String> stringStream2 = Stream.of("hello", "Mysql", "java");
