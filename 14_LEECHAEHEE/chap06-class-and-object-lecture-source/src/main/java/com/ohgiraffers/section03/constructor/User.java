...
//        this.id = id;
//        this.pwd = pwd;
//        this.name = name; 멤버 변수, 인스턴스 변수
        this(id, pwd, name); // this 생성자를 통해 다른 생성자를 활용하여 코드를 줄임. 단 항상 첫줄에 명시해야함.
        this.enrollDate = enrollDate;
        System.out.println("User 클래스의 모든 필드를 초기화하는 생성자 호출됨...");
    }
//  User 생성자가 3개지만 매개변수 타입이 모두 다르기 때문에 오류 x. 오버로딩
    public String information() {
        return "id: " + this.id + " pwd: " + this.pwd + " name: " + this.name + " Date: " + this.enrollDate;
    }
}
