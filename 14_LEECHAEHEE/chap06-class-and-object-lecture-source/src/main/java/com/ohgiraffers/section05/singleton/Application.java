...
public class Application {
    public static void main(String[] args) {
        ...
        System.out.println("singlton의 hashCode : " + singleton.hashCode());
        System.out.println("singlton2의 hashCode : " + singleton2.hashCode());

        LazySingleton lazySingleton = LazySingleton.getInstance();
        LazySingleton lazySingleton2 = LazySingleton.getInstance();
        System.out.println("lazySinglton의 hashCode : " + lazySingleton.hashCode());
        System.out.println("lazySinglton2의 hashCode : " + lazySingleton2.hashCode());
    }
}
