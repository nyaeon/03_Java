...
//        EagerSingleton eagerSingleton = new EagerSingleton();
        ...
        System.out.println("singleton1의 해시코드 : " + singleton1.hashCode());
        System.out.println("singleton2의 해시코드 : " + singleton2.hashCode());

        LazySingleton lazysingleton1 = LazySingleton.getInstance();
        LazySingleton lazysingleton2 = LazySingleton.getInstance();

        System.out.println("lazysingleton1의 해시코드 : " + lazysingleton1.hashCode());
        System.out.println("lazysingleton2의 해시코드 : " + lazysingleton2.hashCode());
    }
}
