...
public class Application {
    public static void main(String[] args) {
        ...
        System.out.println("=========================================================");
        DeptmentStore store = new DeptmentStore();
        store.getStockCount();
        store.buyProduct(3);
        store.getStockCount();

        DeptmentStorePurchase overseas = new DeptmentStorePurchase();
