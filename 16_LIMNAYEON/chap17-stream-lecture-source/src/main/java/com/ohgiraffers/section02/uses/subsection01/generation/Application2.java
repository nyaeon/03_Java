...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * boxed() : 기본타입 스트립인 XXXStream을 박싱하여 Wrapper타입의 Stream<XXX>으로 반환한다.
        * */
        ...
        Stream<String> splitStream = Pattern.compile(", ").splitAsStream("html, css, javascropt");
...
//        stringStream2.forEach(System.out::println);
        ...
        // concat()을 이용하여 두 개의 스트림을 동일 타입으로 스트림으로 합칠 수 있다.
        // 스트림은 1회성으로 사용 가능하며, 이미 열린 스트림은 재사용이 불가능하다.
        // 위에꺼 주석을 안 하면 IllegalStateException 발생한다.
