...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < str1.length(); i++) {  // 메소드
        ...
        // compreaToIgnoreCase() : 대소문자를 구분하지 않고 비교
        ...
        System.out.println("substring(3, 6) : " + javamysql.substring(3, 6)); // amy  n부터 n미만
        System.out.println("substring(3) : " + javamysql.substring(3)); // amysql n부터 끝
