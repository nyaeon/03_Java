...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("likedList의 size" + linkedList.size());
        ...
        System.out.println("linkedLsit : " + linkedList);

        linkedList.remove(2); // linkedList는 ArrayList와 달리 부분적인 요소 제거에서 성능이 우수하다.
        System.out.println("linkedLsit : " + linkedList);  // index2의 apple이 제거됨

        linkedList.clear(); // 전체 요소들 제거
        System.out.println("linkedLsit : " + linkedList.isEmpty());  // 비어있으면 true
    }
}
