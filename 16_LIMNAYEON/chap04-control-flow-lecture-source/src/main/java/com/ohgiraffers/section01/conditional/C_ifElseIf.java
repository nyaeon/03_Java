...
public class C_ifElseIf {
    public void testSimpleIfElseIfStatement(){
        String texts = """
                ...
                연못에서 산신령이 나타난 금도끼, 은도끼, 쇠도끼를 들고 나타났다.
        ...
        if (answer == 1) {
            ...
            System.out.println("오호~~~~ 정직하구나 여기있는 금도끼, 은도끼, 쇠도끼를 다 가져가거라 언넝");
        }
    ...
    public void nestedIfElseIfStatement() {
        ...
        String grade = "";
//        if(point >= 90){
////            String grade = "A"; 지역변수로 출력값이 나오지 않는 상황 발생, 전역변수로 지정해야 한다.
//                grade = "A";
//            if(point >= 95){
//                grade += "B";
//            }
...
//            grade += "F";
//        }
//        System.out.println(name + "학생의 점수는 " + point + "점이고, " + grade + "등급 입니다.");
