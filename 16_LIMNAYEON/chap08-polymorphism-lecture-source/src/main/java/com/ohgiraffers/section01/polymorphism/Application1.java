...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        *
        * Rabbit은 Rabbit 타입이기도 하고, Animal 타입이기도 하다.
        * Tiger는 Tiger 타입이기도 하고, Animal 타입이기도 하다.
        * */
...
//        Tiger tiger1 = new Animal();
        ...
        animal1.cry();; // 컴파일때서는 animal을 가지고 있지만, 런타임시 rabbit 값을 가져옴.
        animal2.cry();

        /*
        객체별로 교유한 기능을 동작시키기 위해서는 레퍼런스 변수를 형변화하여 Rabbit과 Tiger로 변경해야
        메소드 호출이 가능하다.
...
//        ((Tiger) animal1).bite(); // 예외 발생
        ...
        * */
        Animal animal3 = new Rabbit(); // up-casting(묵시적 형변환)
        Animal animal4 = (Animal) new Rabbit(); // up-casting(명시적 형변환)

        Rabbit rabbit1 = (Rabbit) animal; // Anmal => Rabbit down-casting(명시적 형변환)
//        Rabbit rabbit2 = animal1; // dwon-casting은 묵시적 형변환 안 됨
    }
}
