...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        String subNmae = "";
        switch (fieldNo) {
            case Subjects.JAVA: subNmae = "JAVA"; break;
            case Subjects.MYSQL: subNmae = "MySQL"; break;
            case Subjects.JDBC: subNmae = "JDBC"; break;
        }
        System.out.println("선택한 과목명은 : " + subNmae + "입니다.");

        // 같은 클래스에 속한 상수들을 순회(반복자/반복문)할 수 없다. (필드가 총 몇 개고 어떤 필드들이 있는지)
        // 타입의 안전성을 보장할 수 없다.
        printSubjects(Subjects.JAVA);
        printSubjects(0); // 그냥 숫자의 개념도 허용된다.
    }
