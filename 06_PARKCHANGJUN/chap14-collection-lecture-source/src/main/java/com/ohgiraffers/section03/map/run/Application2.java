...
//            prop2.load(new FileReader("src/main/java/com/ohgiraffers/section03/map/run/driver.properties"));
        ...
        System.out.println("prop2 : " + prop2);
        System.out.println("drvier : " + prop2.getProperty("driver"));
        // 값을 수정하고 싶으면 setProperty, 값을 가져오고 싶으면 getProperty
        System.out.println("drvier : " + prop2.getProperty("url"));
        System.out.println("drvier : " + prop2.getProperty("user"));
        System.out.println("drvier : " + prop2.getProperty("password"));
    }
}
