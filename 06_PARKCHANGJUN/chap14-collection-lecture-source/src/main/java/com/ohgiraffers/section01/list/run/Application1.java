...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        List list = new ArrayList(); // 다형성이 일어남
        ...
        alist.add("apple");
        // 인덱스값은 내가 넣고자하는 위치 값.
        alist.add(2, "banana"); // 인덱스 2번에 위치하고 나머지는 한칸씩 뒤로감.

        System.out.println("alist = " + alist); // 중복된 값도 추가 가능
//        alist = [apple, 123, 45.67, Tue Apr 08 16:15:50 KST 2025, apple, banana]
        ...
        List<String> stringList = new ArrayList(); // 문자열 밖에 못들어온다.
        stringList.add("apple");
        stringList.add("banana");
//        stringList.add(123); // 문자열만 가능.
//        System.out.println("stringList = " + stringList);
        ...
        Collections.sort(integerList); // default는 오름차순 정렬
        System.out.println("integerList = " + integerList);

        stringList = new LinkedList<>(stringList); // 자기 포함 및 하위
