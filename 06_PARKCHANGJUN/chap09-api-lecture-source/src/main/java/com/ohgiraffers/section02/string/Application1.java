...
public class Application1 {
    ...
    public static void main(String[] args) {
         ...
         * 배열에서는 length 길이로 사용, String에서는 length 메소드로 사용
         * */
        String str1 = "apple";
        ...
        System.out.println("compareTo() : " + (str2.compareTo(str3))); // 두 문자열이 같기 때문에 결과값은 0
        ...
        // compareToIgnoreCase() : 대소문자를 구분하지 않는 비교

        System.out.println("compareToIgnoreCase() : " + (str3.compareToIgnoreCase(str4))); // 대소문자를 구분하지 않기 때문에 결과값은 0
         ...
         * 단, 일치하는 문자가 없는 경우 -1을 반환한다.
         **/
        System.out.println("lastIndexOf() : " + indexOf.lastIndexOf('a')); // 0,1,2,3. 뒤에서 찾고. 값의 대한 것은 앞에서부터 찾는다.
        System.out.println("lastIndexOf() : " + indexOf.lastIndexOf('z')); // 0,1,2,3. 뒤에서 찾고. 값의 대한 것은 앞에서부터 찾는다.
        ...
        System.out.println("substring(3, 6) : " + javamysql.substring(3, 6)); // 3부터 6미만. 따라서 amy로 나온다.
        System.out.println("substring(3) : " + javamysql.substring(3)); // amysql
        System.out.println("javamysql : " + javamysql); // 원본 값은 그대로 유지
