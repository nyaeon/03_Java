...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        // 오버라이딩 되지 않은 toString() 또는 name() 메소드를 활용하여 문자열로 변경하기 쉽다.
        System.out.println(Subjects.JAVA.toString()); // 여기서는 toSring이 생략됨. 오버라이딩이 되면 원하는 것으로 바꿔서 사용할 수 있다.
        System.out.println(Subjects.JAVA.name().toString());
        ...
        Subjects.FrontEnd frontend = Subjects.FrontEnd.JAVASCRIPT;
        ...
        for (Subjects subject : subjects) {
            ...
            System.out.println(subject.ordinal()); // enum이 가지고 있는 순번으로도 가져올 수 있다.
        }
...
//        printSubjects(Subjects.BackEndCSS);
//        printSubjects(4);
//        printSubjects("CSS");
        // 위에 다 안됨
    }
