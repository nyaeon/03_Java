...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean createSuccess = file.createNewFile(); // 새로운 파일 생성
        ...
        String path = "/Users/parkchangjun/Documents/Dev/devTest/Test";
        ...
        boolean deleteSuccess2 = new File("/Users/parkchangjun/Documents/Dev/devTest").delete();
