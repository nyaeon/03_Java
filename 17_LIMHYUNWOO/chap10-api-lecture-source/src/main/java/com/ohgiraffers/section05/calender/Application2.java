...
public class Application2 {
    public static void main(String[] args) {
         ...
         * 2.후손 클래스인 GregorianCalender 클래스를 이용해서 인스턴스 생성하는방법
         */
        ...
        int startDayOfMonth = calendar1.get(5);
        ...
        System.out.println("startMonth = "+startMonth);
        int startDayOfMonth2 = calendar1.get(Calendar.DATE);
        System.out.println("startDayOfMonth = "+startDayOfMonth);

        // 요일 : 일(1) 월(2) 화(3) 수(4) 목(5) 금(6) 토(7) 기준
