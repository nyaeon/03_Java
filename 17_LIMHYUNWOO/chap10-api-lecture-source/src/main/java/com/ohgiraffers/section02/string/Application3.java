...
public class Application3 {
    public static void main(String[] args) {
      ...
      while(st1.hasMoreTokens()){ // hashMoreTokens() : 현재꺼낼 토큰이 있는지 없는지 체크
          System.out.println("st1 : " + st1.nextToken());
      }
        while(st2.hasMoreTokens()){ // hashMoreTokens() : 현재꺼낼 토큰이 있는지 없는지 체크
            System.out.println("st2 : " + st2.nextToken());
        }
        while(st3.hasMoreTokens()){ // hashMoreTokens() : 현재꺼낼 토큰이 있는지 없는지 체크
            System.out.println("st3 : " + st3.nextToken());
        }
        System.out.println("=================================");
        while(st3.hasMoreTokens()){ // hashMoreTokens() : 현재꺼낼 토큰이 있는지 없는지 체크 -->한번 사용하고 나면 객체 이용해서 다시 잘라야함
            System.out.println("st3 : " + st3.nextToken());
        }
...
//        String[] colors = colorStr.split("#/");
        ...
        StringTokenizer colocStirngTokenizer = new StringTokenizer(colorStr,"*#/");
        while(colocStirngTokenizer.hasMoreTokens()){
            System.out.println("colocStirngTokenizer : "+colocStirngTokenizer.nextToken());
        }
