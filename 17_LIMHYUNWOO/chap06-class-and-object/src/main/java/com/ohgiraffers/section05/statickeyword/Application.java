...
import com.ohgiraffers.section05.StaticFieldTest;

public class Application {
    public static void main(String[] args) {
        /**
         * static
         *  : 프로그램이 실행될 때 정적 메모리 영역(static 영역 또는 클래스영역)에
         *    할당하는 키워드이다. 여러 인스턴스가 공유해서 사용할 목적의 공간이다. 대표적인 예로 싱글톤 객체가 있다.
         */
        ...
        store.buyProduct(3);
        store.getStockCount();
        OverseasDirectPurchase app = new OverseasDirectPurchase();
        app.buyDirectPurchase(10);
        store.getStockCount();
