...
public class Application {
    ...
    public static void main(String[] args){
        ...
        * */
        ...
        try {
            // 파일을 생성 후 성공/실패 여부를  boolean으로 리턴(생성되면 true)
            boolean createSuccess = file.createNewFile();

            // 최초 실행하면 새롭게 파일이 만들어지기 때문에 true로 반환한다.
        ...
        boolean deleteSucces = filePath.delete();
        System.out.println("deleteSucces = " + deleteSucces);

        boolean deleteSucces2 = new File("c:\\devTest").delete();
        System.out.println("deleteSucces2 = " + deleteSucces2);
