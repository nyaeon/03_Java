...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        // 언더플로우
        // 오버플로우와 반대 개념으로 최소 범위보다 작은 수를 발생 시키는 경우의 수
        num1--;
        System.out.println("num1 = " + num1);
        num1--;
        System.out.println("num1 = " + num1);
        ...
        System.out.println("multi = " + multi); // 런타임 에러
        
        long longMulti = firstNum * secondNum;
        System.out.println("longMulti = " + longMulti); //오버플로우 발생 이유는 계산 할때 first 와 second 가 둘 다 int 형으로 계산이 되기 때문에
                                                        // 이미 오버플로우 된 값이 대입되기 때문에 오류가 난다.
        //강제 형변환
