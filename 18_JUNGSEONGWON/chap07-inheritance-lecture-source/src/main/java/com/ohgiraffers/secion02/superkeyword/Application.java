...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        Product product2 = new Product("S-01234", "삼성","갤럭시Z폴드",2800000,new Date());
        System.out.println(product2.getInformation());

        Computer compter1 = new Computer();
        System.out.println(compter1.getInformation());

        Computer computer2 = new Computer("퀄컴 스냅드래곤",512,"Andriod",12);
        System.out.println(computer2.getInformation());

        Computer computer3 = new Computer("S-01234","삼성","은하수폴드3",2000000,new Date(),"퀄컴 스냅드래곤",512,"Andriod",12);
