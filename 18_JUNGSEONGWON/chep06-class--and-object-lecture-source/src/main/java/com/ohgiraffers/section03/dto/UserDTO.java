...
public class UserDTO { // UserDto 표기법의 차이이다.
    /*
     *  자바빈(Java Bean)이란?
    ...
    // 2. 생성자(기본생서아 필수로 명시적 작성)


    public UserDTO() { // 프로젝트 창 에서 Alt + insert를 하면 Constructor를 생성 할 수 있다.
    }
    ...
    public void setId(String id) {
        this.id = id; //지역변수와 전역변수의 명칭이 똑같아 지역 변수의 값은 전역에 넣어줄려고  this.id를 사용하였다.
    }
