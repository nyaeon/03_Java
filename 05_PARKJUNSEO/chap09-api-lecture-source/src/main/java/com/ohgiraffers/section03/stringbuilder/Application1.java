...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("sb : " + sb);    // sb 뒤에 toString이 있음 (오버라이딩으로 생략)
        ...
        System.out.println("sb의 hashCode() : " + sb.hashCode());    // 새로운 주소가 아니라, 같은 주소에 추가해줌

        String str2 = "world";
        System.out.println(str2.hashCode());
        str2 += "world";
        System.out.println(str2.hashCode());        // String은 문자열을 합치면 다른 주소에 새로 생성하는 거임
