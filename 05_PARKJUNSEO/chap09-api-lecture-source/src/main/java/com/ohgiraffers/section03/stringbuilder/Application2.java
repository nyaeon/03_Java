...
public class Application2 {
    public static void main(String[] args) {
        ...
        * 기본용량 : 문자열 + 16
        * */
        System.out.println(sb.capacity());   // .capacity는 용량을 나타냄  // 기본 용량은 16
        /*
        ...
        * */
        ...
        System.out.println("deleteCharAt() : " + sb2.deleteCharAt(2));    // 원본에 영향을 준다.
        System.out.println("sb2 : " + sb2);    // 원본에 영향을 준다.
        ...
        * */
        ...
        /*
        * reverse() : 문자열 인덱스의 순번을 역순으로 재배열한다.
        * 원본에 영향을 준다.
        * */
