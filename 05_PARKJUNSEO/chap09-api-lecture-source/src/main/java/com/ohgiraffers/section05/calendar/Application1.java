...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        Date date = new Date();
        System.out.println(date);        // 현재 날짜와 시각

        // getTime() : 1970년 1월 1일 0시 0분 0초 이후 지난 시간을 밀리초로 계산해서 long 타입으로 반환
        System.out.println(date.getTime());

        Date time = new Date(1743751050156L);
        System.out.println(time);    // 이때의 시간
