...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * 인덱스를 벗어난 정수를 인자로 전달하는 경우에는 IndexOutOfBoundException이 발생
        * */
...
// ================================================================================
        ...
        System.out.println("compareTo(): " + str2.compareTo(str4)); // 32 (첫 글자 비교)
        System.out.println("compareTo(): " + str4.compareTo(str2)); // -32 (첫 글자 비교)
        ...
        System.out.println("compareToIgnoreCase(): " + str3.compareToIgnoreCase(str4)); // 5
// ================================================================================
        /*
         * concat() : 문자열에 인자로 전달된 문자열을 합치기해서 새로운 문자열을 반환한다.  ==> 새로운 주소값으로 탈바꿈해서 반환한다는 뜻
         * 원본 문자열에는 영향을 주지 않는다.
         * */
...
// ================================================================================
        /*
         * indexOf() : 문자열에서 특정 문자를 탐색하여 처음 일치하는 인덱스 위치를 정수형으로 반환한다.             // 문자 탐색
         * 단, 일치하는 문자가 없는 경우 -1을 반환한다. (왼쪽부터 탐색)
         * */
...
// ================================================================================
        /*
         * lastIndexOf() : 문자열 탐색을 뒤에서부터 하고 처음 일치하는 위치의 인덱스를 반환한다.                  // 문자 탐색
...
// ================================================================================
        ...
        * .substring(a, b) : a 인덱스 위치부터 b 인덱스 전까지              // 인덱스 기준
        * */
