...
public class Application3_forMember {
...
//        System.out.println("==========================================================");
        ...
        String str1 = memberList.stream().map(Member::toString).collect(Collectors.joining());
        System.out.println("str = " + str1);

        String str2 = memberList.stream().map(Member::toString).collect(Collectors.joining("," ));
