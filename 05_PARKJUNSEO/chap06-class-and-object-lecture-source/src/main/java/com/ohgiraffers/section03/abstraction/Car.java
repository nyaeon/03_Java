...
public class Car {
    ...
    public void go() {
        if (isOn) { // 시동이 걸려 있어야 달릴 수 있음
            this.speed += 10;
            System.out.println("차가 앞으로 움직입니다. 현재 속도는 " + speed + "km/h 입니다.");
        } else {
    ...
    public void turnOff () {
        if (speed > 0) {
            ...
            System.out.println("이미 시동이 꺼져 있는 상태입니다. 시동을 상태를 확인해주세요.");
        }
    }
}