...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        //ArrayList() : 기본적으로 10개의 방을 가지고 있음.
        ArrayList alist = new ArrayList();

        //List로 하면 다형성으로 담아주기만 한거라 ArrayList처럼 계속 변환시켜주지 않아도됨.
        List list = new ArrayList();

        Collection clist = new ArrayList();

        alist.add("apple"); // 값을 추가하고 싶다면 .add
        alist.add(123); // autoboxing된 것(값-> 객체)
        alist.add(45.67);
        alist.add(new Date());
        ...
        alist.add("apple");
        alist.add(2,"banana"); // index의 값은 내가 넣고자하는 위치값이다.
        //alist = [apple, 123, banana, 45.67, Tue Apr 08 16:16:40 KST 2025, apple]

        System.out.println("alist = " + alist);
        //alist = [apple, 123, 45.67, Tue Apr 08 16:14:23 KST 2025, apple]

        //인덱스 값 삭제
        alist.remove(2);
        System.out.println("alist = " + alist);

        //set은 특정 인덱스의 값을 바꾸겠다.
        alist.set(4,Boolean.valueOf(true));
        System.out.println("alist = " + alist);

        List<String> stringList = new ArrayList<>();
        stringList.add("apple");//내용의 값은 문자열이 들어간다.
        //stringList.add(123);//들어갈 수 x.에러발생
        ...
        System.out.println("stringList = " + stringList); // 확인하면 정렬이 일어날거다.
        ...
        System.out.println("integerList = " + integerList);//오름차순으로 출력

        // 받아주는 타입을 상위 타입으로 하면 편함.
