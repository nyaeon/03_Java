...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        // getTime() : 1970년 1월 1일 0시 0분 0초 이후 지난 시간을 millisecond로 계산해서 long타입으로 변환
        System.out.println(date.getTime());// ms 단위로 씀.
        // 1초 : 1000밀리초-->5초 : 5000밀리초, 0.5초 : 500밀리초
        // 1분 : 60초
        // 1시간 : 60분
        // 하루 : 24시간

        // 1000 * 60(초) *60(분) = 1시간 * 24 = 하루

        Date date2 = new Date(1743751042699L);
