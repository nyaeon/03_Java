...
public class Application3 {
    ...
    public static void main(String[] args) {
         ...
         * 
         * 
         * // 정규표현식은 regex()임. 구분자를 딜리미터?라고 한다함.
         * */
        ...
        while (st1.hasMoreTokens()){ // hashMoreTokens() : 현재 꺼낼 토큰이 있는지없는지 체크
            System.out.println("st1 : " + st1.nextToken());
        }
        while (st2.hasMoreTokens()){ // hashMoreTokens() : 현재 꺼낼 토큰이 있는지없는지 체크
            System.out.println("st2 : " + st2.nextToken());
        }
        while (st3.hasMoreTokens()){ // hashMoreTokens() : 현재 꺼낼 토큰이 있는지없는지 체크
            System.out.println("st3 : " + st3.nextToken());
        }
        System.out.println("======================"); // 다시 쓸 수 없음. 다시 쓰려면 객체 이용해서 다시 잘라야함.
        while (st3.hasMoreTokens()){ // hashMoreTokens() : 현재 꺼낼 토큰이 있는지없는지 체크
            System.out.println("st3 : " + st3.nextToken());
        }
