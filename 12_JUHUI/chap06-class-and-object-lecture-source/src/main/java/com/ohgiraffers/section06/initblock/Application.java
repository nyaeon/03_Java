...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        //Product product2 = new Product("대륙폰", 100000, "샤우미");
        //System.out.println(product2.getInformation());

        // 인스턴스 변수 : 기본값(JVM) => 명시적 초기값 => 인스턴스 초기화 블록 => 생성자
        // 클래스 변수 : 기본값(JVM) => 명시적 초기값 => 정적초기화블럭 => 인스턴스초기화블럭 => 생성자
    }
}
