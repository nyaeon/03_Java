...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /*
         * enum 타입의 필드를 최초 사용시에만 열거 타입의 인스턴스르 생성하고 생성자를
        ...
        Iterator<UserRole2> userRole2Iterator = roles.iterator();
        while (userRole2Iterator.hasNext()) {
            UserRole2 role = userRole2Iterator.next();
        ...
        Iterator<UserRole2> userIterator = users.iterator();
