...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        // 매개변수 없고, 리턴값도 없는 람다
        //Runnable 인터페이스, runn() 이란 메소드가 하나 있음. 필요한 매개변수가 없음. 사용 후 어떤 값을 주겠다는 리턴값도 없음.
        ...
        /* Consumer<T>#accept(T t)   :  객체 T를 받아 소비하는 게 끝. 그래서 반환 타입을 가지고 있지 않음. */

        Consumer<String> consumer = (String str) -> System.out.println(str + "가 입력됨.");
        ...
        /* ObjcetConsumer<T>#accept<T t, int value) : void > 객체 T와 int 값을 받아 소비한다. */
