...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("===============================");
        // 음수를 마지막 인자 넣어주게 되면 마지막 구분자 뒤의 값이 존재하지 않는 경우 빈 문자열로 토큰을 생성
        ...
        while (st1.hasMoreTokens()){ // hasMoreTokens() : 현재꺼낼 토큰이 있는지 없는지 체크
            System.out.println("str1 : " + st1.nextToken());
        }


        while (st2.hasMoreTokens()){ // hasMoreTokens() : 현재꺼낼 토큰이 있는지 없는지 체크
            System.out.println("str2 : " + st2.nextToken());
        }


        while (st3.hasMoreTokens()){ // hasMoreTokens() : 현재꺼낼 토큰이 있는지 없는지 체크
...
//        String[] colors = colorStr.split("#/ ");
        ...
        // StringTokenizer의 두 번째 인자 문자열 자체는 연속된 문장이 아닌 하난하나를 구분자로  이용하겠다는 뜻
