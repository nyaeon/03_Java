...
public class Application {
    ...
    * 한번에 확인하고 활용할 수 있다.*/
        ...
        System.out.println("consumer2 == consumer2 = " + (consumer2==consumer2));

        System.out.println("set으로 바꿔 반복자를 활용해 보자.");
        EnumSet<UserRole2> roles = EnumSet.allOf(UserRole2.class);
        Iterator<UserRole2> user2Iterator = roles.iterator();
        ...
        Iterator<UserRole2> userIterator2 = roles.iterator();
