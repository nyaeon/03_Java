...
public class Application {
    ...
    private static Member reform(Member member){
//        Member modifiedMember = new Member();
//        modifiedMember.setId(member.getId());
        ...
        while(true) {
            ...
            switch (chooseNo) {
                ...
                case 3:
                    ...
                    member.setHobbies(resetHobbies());
                    break;
                case 4:
                    System.out.print("수정 할 혈액형을 입력하세요: ");
                    member.setBloodType(resetBloodType());
                    break;
                case 5:
    ...
    private static Member signUp(){
        ...
        * 1. 생성자 방식 : (장 : 한줄코딩, 단, 따로 생성자 추가 및 생성자의 매개변수가 다소 늘어날 수 있음(리책토링 징조))
        * 2. setter 방식 : (장 : 초기화 할 갯수 수정 용이, 가독성 좋음,단, 코드의 줄 수가 늘어남.
        * */
