        ...
        * JDK 1.0 부터 지원하는 API로 파일 처리를 수행하는 대표적인 클래스
        ...
        try {
           ...
           boolean createSuccess = file.createNewFile();
            // 최초 실행하면 새롭게 파일이 만들어지기 때문에 true가
            //
        ...
        String path = "/Users/yudaeun/dev/03_Java/08_YUJIEUN/devTest/test";
        ...
        boolean deleteSucess2 = new File( "/Users/yudaeun/dev/03_Java/08_YUJIEUN/devTest/test").delete();
        System.out.println("deleteSucess2 = " + deleteSucess2);
