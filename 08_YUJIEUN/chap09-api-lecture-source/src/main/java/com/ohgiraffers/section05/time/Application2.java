...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("월 중에 몇번째 : " + date.getDayOfMonth());
        System.out.println("1년 중에 몇 번때 일 : " + date.getDayOfYear());
        System.out.println("한 주의 몇 번때 일 : " + date.getDayOfWeek());

        ZonedDateTime zonedDateTime = ZonedDateTime.now();
        System.out.println("zonedDateTime = " + zonedDateTime);
        System.out.println("zone informtion = " + zonedDateTime.getZone());
        System.out.println("시차 = " + zonedDateTime.getZone());
