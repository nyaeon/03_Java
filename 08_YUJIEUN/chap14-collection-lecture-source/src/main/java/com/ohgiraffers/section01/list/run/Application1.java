...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        alist.add("apple");
//        alist = [apple, 123, 84.75, Tue Apr 08 16:15:59 KST 2025, apple, banana]
        alist.add(2, "banana"); // index값은 내가 넣고자하는 위치값
//        alist = [apple, 123, banana, 84.75, Tue Apr 08 16:17:37 KST 2025, apple]
        System.out.println("alist = " + alist);
...
//        stringList.add(123); // 에러 발생
        ...
        Collections.sort(stringList); //String 에는 문자열 오름차순(Ascendilng)에 대한 정의가 되어 있다.
        System.out.println("stringList = " + stringList);
