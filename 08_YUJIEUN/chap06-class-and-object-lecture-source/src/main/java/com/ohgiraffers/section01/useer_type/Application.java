package com.ohgiraffers.section01.useer_type;

public class Application {
    public static void main(String[] args) {
        /*
        *객체지향프로그래맹(OOP : Obecit Oriented Programming language)란?
        * 캡슐화, 추상화,추상화,다형성을 적용하여 유지보수성을 고려한 응집력 높고 결합도 낮은
        *
        * 객체지향의 특징(4대틀징)
        * -추상화(Abstraction)
        * - 캡슐화(Encapsulation)
    ...
    public static Member modifyMember(Member m){
