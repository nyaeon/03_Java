        ...
        //       while (true) {
            ...
            //           switch (choice) {
                ...
                //               default :
                    ...
                    //           }//주문 요청 취소
            //           private void sendCoddeeRequest(Order order){
                //               Coffee[] coffees = barista.makeCoffee(order);
                //               System.out.println("커피나옴"+ Arrays.toString(coffees));
                //           }
            //           if(order != null){
...
//               주문처리 1.승인 2.취소
//               입력:
//               """.formatted(createOrder.getName(), createOrder.getOption(), createOrder.getCount()));
        ...
        //       private String inputoption(){
            //           System.out.println("옵션 선택 1.hot 2.ice:");
    ...
    //   private Order createOrder(String 라떼) {
        //   }

    //   private Order createorder(String 아아) {
        //   }
    //
