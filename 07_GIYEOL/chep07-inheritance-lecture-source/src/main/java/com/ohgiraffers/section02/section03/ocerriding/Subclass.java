package com.ohgiraffers.section02.section03.ocerriding;
...
//       super.method(num);
//   }
//  4.메소드 이름과 리턴 타입, 매개변수의 갯구 , 타입, 순서가 일치하는 경우 오버라이딩 성립
 ...
 //  public final void finalmethod(){}
    ...
    //7.부모 클래스의 메소드의 접근 제한자와 같거나 더 넓은 범위로 오버라이딩 가능
