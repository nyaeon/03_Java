...
public class Application3 {
    public static void main(String[] args) {
        ...
        System.out.println("==============================================");
        //음수를 마지막 인자로 넣러주게 되면 마지막 구분자 뒤의 값이 존재하지 않는 경우 빈 문자열로 토큰을 생성
        ...
        //StringTokenizer의 두번째 인자 문자열 자체는 연속된 문자열이 아닌 하나하나를 구분자로 이용하겠다는 의미
        StringTokenizer color = new StringTokenizer(colorStr,"*#/");
        while(color.hasMoreTokens()){
            System.out.println("color: " + color.nextToken());
        }
