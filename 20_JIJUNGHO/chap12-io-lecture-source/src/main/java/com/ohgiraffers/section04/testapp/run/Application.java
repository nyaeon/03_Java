...
public class Application {
        ...
        while (true) {
            ...
            switch (input) {
                ...
                case 9:
                    return;
                default:
                    System.out.println("번호를 잘못 입력했음");
                    break;
            }
        }
    }
    ...
    private static String[] resetHobbies() {
        Scanner sc = new Scanner(System.in);
        System.out.print("수정할 취미 개수를 입력하세요(숫자로 1이상) : ");
    ...
    private static Member signUp() {
         ...
         * 1. 생성자 방식 : (장점 : 한줄코딩, 단점 : 따로 생성자 추가 및 생성자의 매개변수가 다소 늘어날 수 있음(리펙토링 징조))
         * 2. setter 방식 : (장점 : 초기화할 갯수 수정 용이, 가독성이 좋음, 단점 : 코드의 줄 수가 늘어남)
         */
