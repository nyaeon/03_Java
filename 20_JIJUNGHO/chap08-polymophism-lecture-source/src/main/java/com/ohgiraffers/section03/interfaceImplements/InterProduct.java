...
public interface InterProduct extends java.io.Serializable /*, java.util.Comparator */ {
    ...
    // 인터페이스는 상수필드만 가질수 있기 때문에 모든 필드는 묵시적으로 public static final이다. (생략가능)
    int MIN_NUM = 10;
    ...
    void abstractMethod(); // public abstract 생략 가능

    // JDK 1.8 추가된 기능 - static void 메소드 작성 가능
    public static void staticMethod() {
        System.out.println("InterProduct 클래스의 staticMethod 호출됨...");
    }

    // JDK 1.8 추가된 기능 - non-static 메소드 작성 가능 (default)
