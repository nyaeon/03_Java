...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("singleton의 hashCode : " + singleton.hashCode());
        System.out.println("singleton2의 hashCode : " + singleton2.hashCode());

        LazySingleton lazySingleton = LazySingleton.getInstance();
        LazySingleton lazySingleton2 = LazySingleton.getInstance();

        System.out.println("lazySingleton의 hashCode : " + lazySingleton.hashCode());
        System.out.println("lazySingleton2의 hashCode : " + lazySingleton2.hashCode());
    }
}
