...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("compareTo() : " + (str2.compareTo(str4)));  // 32 (= 106-74)
        System.out.println("compareTo() : " + (str4.compareTo(str2)));  // -32 (= 74-106)

        System.out.println("compareTo() : " + (str2.compareTo(str5)));  // -5 (= 106-111)
        System.out.println("compareTo() : " + (str5.compareTo(str2)));  // 5 (= 111-106)
        ...
        String trimStr = "      java        ";
        System.out.println("trimsStr : #" + trimStr + "#");
        System.out.println("trimsStr : #" + trimStr.trim() + "#");
        System.out.println("trimsStr : #" + trimStr + "#");
