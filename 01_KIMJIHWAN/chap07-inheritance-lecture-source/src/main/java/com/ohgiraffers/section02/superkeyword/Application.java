...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        Product product2 = new Product("S-01234", "삼송", "갤럭시Z폴드3", 2000000, new Date());
        ...
        Computer computer3 = new Computer("S-01234", "삼송", "은하수Z폴드3", 200000, new Date(), "퀄컴 스냅드래곤", 512, 12, "안드로이드");
