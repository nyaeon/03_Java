...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /*
        * enum 타입의 필드는 최초 사용 시에만 열거 타입의 인스턴스를 생성하고 생성자를
        ...
        * 한번에 확인하고 활용할 수 있다.
        ...
        System.out.println((consumer.ordinal()) + " " + consumer.getDescription());
        ...
        while (userInterator2.hasNext()) {
            UserRole2 role2 = userInterator2.next();
            System.out.println(role2.ordinal() + " " + role2.name() + " " + role2.getDescription());
        }
    }
}
