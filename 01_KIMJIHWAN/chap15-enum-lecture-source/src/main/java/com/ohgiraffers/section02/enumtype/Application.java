...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        Subjects subject2 = Subjects.JAVA;
        ...
        *    작성한 순서에 따라 각각의 다른 인스턴스가 생성되며 최초 호출 시에 enum의 생성자를 활용해 생성된다.
        *    (lazy singleton 개념)
        * */
        ...
        // 오버라이딩 하지 않은 toString() 또는 name() 메소드를 활용하여 필드명을 문자열로 변경하기 쉽다.
        ...
        Subjects[] subjets = Subjects.values();
        for (Subjects subject : subjets) {
...
//        printSubjects(4);
    ...
    public static void printSubjects(Subjects subject) {    // 이넘타입에 대한 내용만 씀
        System.out.println(subject.toString());             // toString()
    }
}
