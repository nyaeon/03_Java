...
public class ExceptionTest {
    ...
    public void checkEnoughMoney(int price, int money) throws PriceNegativeException, NotEnougMoneyException, MoneyNegativeException {

        if(price < 0){
            // throw를 이용해서 이 부분에서 강제로 예외를 발생시킴
            throw new PriceNegativeException("상품 가격은 음수일 수 있습니다.");
        }
        ...
        if(money < price) {
            throw new NotEnougMoneyException("가진 돈보다 상품 가격이 더 비쌉니다.");
        }
