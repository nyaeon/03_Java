...
//        LinkedList<String> queue = new LinkedList<>(); // LinkedList는 queue중에서도 deque에 해당하여
                                                        // offerfirst(), offerLast() 같은 메소드도 제공된다.

        // PriorityQueue를 활용하면 선입선출 + 정렬의 개념을 가져갈 수 있다.
//        PriorityQueue<String> queue = new PriorityQueue<>();    // String 의 기준대로 문자열 오름차순
        ...
        /*
        * peek() : 해당 큐의 가장 앞에 있는 요소(먼저들어온요소)를 반환
