...
public class Application3 {
    public static void main(String[] args) {
        ...
        while (st1.hasMoreTokens()) { //hasMoreTokens : 현재 꺼낼 토큰이 있는 지 없는 지 체크해서 결과 값을 true false로 알려준다.
...
//     StringTokenizer의 두 번째 인자 문자열 자체는 연속된 문자열이 아닌 하나하나 구분자를 이용하겠다는 의미
        StringTokenizer colorStringTokeninzer = new StringTokenizer(colorStr, "*# /");
        while(colorStringTokeninzer.hasMoreTokens()){
            System.out.println("colorStringTokeninzer : " + colorStringTokeninzer.nextToken());
        }
