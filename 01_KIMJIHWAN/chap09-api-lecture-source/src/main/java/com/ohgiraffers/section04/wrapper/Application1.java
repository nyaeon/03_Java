...
//        Integer boxingNumber1 = new Integer(intValue);
        ...
        System.out.println("intger와 integer 비교 : " + (integerNum1 == integerNum2));
        System.out.println("intger와 integer 비교 : " + (integerNum1 == integerNum3));
        System.out.println("intger와 integer 비교 : " + (integerNum1 == integerNum4));
