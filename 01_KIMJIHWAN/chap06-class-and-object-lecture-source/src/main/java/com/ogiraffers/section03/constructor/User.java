package com.ogiraffers.section03.constructor;
...
public class User {
    ...
    // ++ 매개변수있는 생성자가 존재하면 컴파일러가 기본생성자를 만들어주지 않는다.

    /*
     * 생성자 작성 방법
     * [표현식]
     * 접근제한자 클래스명([매개변수]) { ++매개변수가 있냐 없냐에 따라 기본생성자
...
//        this.id = id;
//        this.pwd = pwd;
//        this.name = name; ++ this는 내가 속해 있는 객체 참조?
    ...
    public String information() {   // this
        return "id: " + id + " pwd " + pwd + " name " + name + " enrollDate " + this.enrollDate;
    }
}
