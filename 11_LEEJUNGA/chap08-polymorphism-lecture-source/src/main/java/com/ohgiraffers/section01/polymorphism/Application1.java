...
public class Application1 {
    public static void main(String[] args) {
        ...
        *
        * Rabbit은 Rabbit타입이기도 하면서 Anmal타입이기도 하다.
        * Tiger은 Tiger타입이기도 하면서 Anmal타입이기도 하다.
        * */
...
//        Rabbit rabbit1 = new Animal();
        ...
        /*
        * 객체별로 고유한 기능을 동작시키기 위해서는 래퍼런스 변수를 형변환하여 Rabbit과 Tiger로 변경해야
        * 메소드 호출이 가능하다.
...
//        ((Tiger) animal1.bite();
        ...
        * */
        System.out.println("\ninstanceof 확인 =========================");
        System.out.println("animall이 Tiger타입인지 확인 : " + (animal1 instanceof Tiger)); // false
        System.out.println("animall이 Rabbit타입인지 확인 : " + (animal1 instanceof Rabbit)); // true
        ...
        * */
        Animal animal3 = (Animal) new Rabbit(); // 업캐스팅 업캐스팅(명시적 형변환)
        Animal animal4 = new Rabbit();          // 업캐스팅(묵시적 형변환)

        /* animal1은 Animal type인 상태*/
        Rabbit rabbit1 = (Rabbit) animal1; // Animal => Rabbit 다운캐스팅(명시적 형변환)
//        Rabbit rabbit2 = animal1; // 묵시적 형변환은 안됨
    }
}
