...
public interface InterProduct extends Serializable {
    ...
    // 인터페이스는 상수필드만 가질 수 있기 때문에 모든 필드는 묵시적으로 public static final 이다.
    public static final int MAX_NUM = 100;
    int MIN_NUM = 10;  // 묵시적으로 public static final 붙어있음
...
//    public void nonStaticMethod() {} // 에러남
    ...
    * */
    ...
    public static void staticMethod() {
        System.out.println("InterProduct 클래스의 staticMethod 호출됨 SSSSSSSSS");
    }

    // (JDK 1.8 추가된 기능)
    public default void defaultMethod() {
        System.out.println("InterProduct 클래스의 defaultMethod 호출됨 DDDDDDDDD");
    }
