...
public class Application1 {
    public static void main(String[] args) {
        ...
        BiConsumer<String, LocalTime> biConsumer =
                (str1, time) -> System.out.println(str1 + "(이)가 " + time + "에 입력함");
        biConsumer.accept("홍길동", LocalTime.now());

        System.out.println("\n=============================IntConsumer==============================\n");

        /* IntConsumer accept(int value) : void : int 값을 받아 소비한다. */
        IntConsumer intConsumer = num -> System.out.println("입력하신 숫자는 " + num);
        ...
        ObjIntConsumer<Random> objIntConsumer =
                (random, bound) ->
                        System.out.println("0부터 " + bound + "전 까지의 난수 발생 : " + random.nextInt(bound));
