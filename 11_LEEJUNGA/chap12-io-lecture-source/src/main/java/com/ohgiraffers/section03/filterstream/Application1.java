    ...
    public static void main(String[] args) {
        ...
        try {
            bw = new BufferedWriter(new FileWriter(
                    "src/main/java/com/ohgiraffers/section03/filterstream/textBuffered.txt"));
            bw.write("안녕하세요\n");
            bw.write("반갑습니다.\n");
        ...
        try {
            br = new BufferedReader(new FileReader("src/main/java/com/ohgiraffers/section03/filterstream/textBuffered.txt"));
