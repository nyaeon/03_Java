...
public class Application1 {
    public static void main(String[] args) {
         ...
         * 원본 문자열에는 영향을 주지 않는다.
         * */
        System.out.println("concat() : " + str2.concat(str3));
        ...
        System.out.println("indexOf() : " + indexOf.indexOf("a"));
        System.out.println("indexOf() : " + indexOf.indexOf("z"));
        ...
        System.out.println("빈 문자열의 길이 : " + "     ".length()); // 5

        // isEmpty() : 문자열의 길이가 0이면 true를 반환, 아니면 false반환
        System.out.println("isEmpty() : " + javamysql.isEmpty()); // false
