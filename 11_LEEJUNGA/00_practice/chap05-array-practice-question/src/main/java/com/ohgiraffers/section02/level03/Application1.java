...
//        app.arrayTest7(arr);
    ...
    public void arrayTest4(int[][] arr) {
        for (int i = 0; i < arr.length; i++) {
            for (int j = 0; j < arr[i].length; j++) {
                arr[i][j] = (int) (Math.pow(arr[i].length, 2) - i - (arr[i].length * j));
                System.out.print(arr[i][j] + " ");
            }
            System.out.println();
        }
    ...
    public void arrayTest5(int[][] arr) {
        for (int i = 0; i < arr.length; i++) {
            for (int j = 0; j < arr[i].length; j++) {
                arr[i][j] = (int) (Math.pow(arr[i].length, 2) - (i * arr[j].length) - (arr[j].length - j) + 1);
                System.out.print(arr[i][j] + " ");
            }
            System.out.println();
        }
    ...
    public void arrayTest6(int[][] arr) {
        for (int i = 0; i < arr.length; i++) {
            for (int j = 0; j < arr[i].length; j++) {
                arr[i][j] = (int) (Math.pow(arr[i].length, 2) - (arr[i].length - i) + 1 - (arr[i].length * j));
                System.out.print(arr[i][j] + " ");
            }
            System.out.println();
        }
    ...
    public void arrayTest7(int[][] arr) {
        for (int i = 0; i < arr.length; i++) {
            for (int j = 0; j < arr[i].length; j++) {
                arr[i][j] = (arr.length - i) + (arr[i].length * j);
                if(arr[i][j] % 3 == 0) arr[i][j] = 0;  // 3의 배수 0처리
                System.out.print(arr[i][j] + " ");
            }
            System.out.println();
        }
