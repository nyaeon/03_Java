...
public class Application2 {
    public static void main(String[] args) {
        ...
        * boxed() : 기본 타입 스트림인 XXXStream을 박싱하여 Wrapper타입의 Stream<XXX>으로 반화한다.
        * */
        ...
        Stream<String> splitStream = Pattern.compile(", ").splitAsStream("heml, css, javascript");
        splitStream.forEach(System.out::println);

        Stream<String> stringStream = Stream.of("hello", "world", "java");
        Stream<String> stringStream2 = Stream.of("welcome", "world", "java");
