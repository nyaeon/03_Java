...
public class OverloadingTest {
     ...
     * 메소드의 메소드명과 파라미터 선언부 부분을
     * 메소드의 시그니처 (signiture) 라고 함. (즉, method(int num))
     * 
     * 동일한 메소드 이름으로 다양한 종류의 매개변수에 따라 
     * 처리해야 하는 경우 적용하는 기술을 오버로딩이라고 한다.
     * 
     * 오버로딩의 조건?
...
// -----------------------------------------------------------------------------------
// public String test() { return "test"; } // 애도 안됨
// Private String test() {return "test"; } // 애도 안됨
// -----------------------------------------------------------------------------------
